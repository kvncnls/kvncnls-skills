...
| [**flywheel**](./flywheel) | Growth is how hard you push; retention is how heavy the wheel is. Finds where a product loses the people it already earned, across four ordered plays—Trust, Friction, Wins, and Emotion. Diagnose a leak or build a stage. |
